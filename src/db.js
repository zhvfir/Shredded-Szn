...
export const FOODS = {
  ...
  beef:         { name: 'Beef mince ~15% fat (raw)',  unit: 'g',     step: 10, kcal: 2.50,  p: 0.18,  c: 0,     f: 0.198 },
...
export const PRESETS = [
  ...
  { name: 'Dinner — sweet potato + whey',
    items: [['sweetpotato', 250], ['chicken', 220], ['egg', 2], ['oil', 1], ['whey', 2]] },
